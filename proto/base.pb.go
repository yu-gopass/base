...
func (x *Ping) Reset() {
	*x = Ping{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_base_base_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Ping) Descriptor() ([]byte, []int) {
	return file_proto_base_base_proto_rawDescGZIP(), []int{5}
}
...
func (x *Pong) Reset() {
	*x = Pong{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_base_base_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return file_proto_base_base_proto_rawDescGZIP(), []int{6}
}
...
var file_proto_base_base_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x62, 0x61, 0x73, 0x65, 0x22, 0x1b, 0x0a,
	...
	,
}
...
var file_proto_base_base_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_base_base_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: base.Message
	(*Request)(nil),           // 1: base.Request
	(*Response)(nil),          // 2: base.Response
	(*StreamingRequest)(nil),  // 3: base.StreamingRequest
	(*StreamingResponse)(nil), // 4: base.StreamingResponse
	(*Ping)(nil),              // 5: base.Ping
	(*Pong)(nil),              // 6: base.Pong
}
var file_proto_base_base_proto_depIdxs = []int32{
	1, // 0: base.Base.Call:input_type -> base.Request
	3, // 1: base.Base.Stream:input_type -> base.StreamingRequest
	5, // 2: base.Base.PingPong:input_type -> base.Ping
	2, // 3: base.Base.Call:output_type -> base.Response
	4, // 4: base.Base.Stream:output_type -> base.StreamingResponse
	6, // 5: base.Base.PingPong:output_type -> base.Pong
...
func file_proto_base_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_base_base_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_base_base_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
